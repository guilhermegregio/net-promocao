...
function emailFormSubmission()
{
	...
	$subject = 'LIGHT BOX Formulário envio';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nome*:</b></td><td>' . htmlentities($_REQUEST["custom_U633"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>CEP*:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Telefone*:</b></td><td>' . htmlentities($_REQUEST["custom_U671"],ENT_COMPAT,'UTF-8') . '</td></tr>';
